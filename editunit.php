...
$prevunitid = optional_param('eunitid', -1, PARAM_INT); //editunit
$astart = optional_param('astart', 0, PARAM_INT); //addunit
$aend = optional_param('aend', 0, PARAM_INT); //addunit
...
if($workerrecord->active == 0 && !$canmanage){
    echo $OUTPUT->header();
...
if ($mform->is_cancelled()){ //user clicked cancel
    ...
    $reports = new moodle_url($CFG->wwwroot.'/blocks/timetracker/reports.php', 
        array('id'=>$courseid)); //TEMP FIX. --MJG
    redirect($reports, $status,1);

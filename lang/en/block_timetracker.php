...
$string['timetracker:addinstance'] = 'Add block to course';
...
$string['managealerts_help'] = 'This page allows the supervisor or administrator to manage alerted work units
    ...
    <ul>
    <li><b>Approve</b> - Accept the worker\'s propsed changes to the work unit.</li>
    <li><b>Delete</b> - Delete the alert and original/proposed work units</li>
...
$string['emessagedisclaimer'] = '(Please note that you will be prompted to sign into TimeTracker in order to complete the request).';
...
$string['workerstatement'] = 'I certify that the hours reported on this timesheet are true, correct, and are within my allotted maximum earnings (if applicable). I understand that if my timesheet is not signed by the due date, I will not be paid for these hours until the next pay period.';
$string['supervisorstatement'] = 'I certify that the hours reported on the selected timesheet(s) are true, correct, and are within each student\'s allotted maximum earnings (if applicable). I understand that if the timesheets are not signed by the due date, the students will not be paid for these hours until the next pay period.';

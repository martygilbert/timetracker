...
class block_timetracker_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        $mform->setType('config_block_timetracker_default_max_earnings', PARAM_INT);
        ...
        $mform->setType('config_block_timetracker_curr_pay_rate', PARAM_FLOAT);
        ...
        $mform->setType('config_block_timetracker_round', PARAM_INT);
        ...
        $mform->setType('config_block_timetracker_department', PARAM_TEXT);
        ...
        $mform->setType('config_block_timetracker_position', PARAM_TEXT);
        ...
        $mform->setType('config_block_timetracker_budget', PARAM_TEXT);
        ...
        $mform->setType('config_block_timetracker_institution', PARAM_TEXT);
        ...
        $mform->setType('config_block_timetracker_supname', PARAM_TEXT);
